# WP57 — Scanner Sources & settings modal — Stories
...
- `docs/wp/wp57-stories.md`, `docs/wp/wp57-progress.md`
...
- [x] **S3 — Checks**
  ...
  - Repo-wide typecheck still fails on pre-existing `evalResults` drift (unrelated).
