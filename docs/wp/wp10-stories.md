...
- [x] `WP10-S1` Extension workspace scaffold
...
- [x] `WP10-S2` Read-only conversation score badge
...
- [x] `WP10-S3` One-click deep link into pre-analyzed workbench
