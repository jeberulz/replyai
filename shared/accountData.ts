export const ACCOUNT_USER_TABLES = [
  ...
  },
  {
    ...
    ownershipField: "userId",
    indexName: "by_user",
    relationshipFields: ["userId", "clusterId"],
    deletionOrder: 65,
  },
  {
  ...
  },
  {
    ...
    ownershipField: "userId",
    indexName: "by_user",
    relationshipFields: ["userId", "experimentId", "runId", "caseId"],
    deletionOrder: 73,
  },
  {
    table: "evalRuns",
    ownershipField: "userId",
    indexName: "by_user",
    relationshipFields: ["userId", "experimentId"],
    deletionOrder: 74,
  },
  {
    table: "evalDecisions",
    ownershipField: "userId",
    indexName: "by_user",
    relationshipFields: ["userId", "experimentId", "runId", "createdByUserId"],
    deletionOrder: 75,
  },
  {
    table: "evalExperiments",
    ownershipField: "userId",
    indexName: "by_user",
    relationshipFields: ["userId", "creatorUserId", "datasetId"],
    deletionOrder: 76,
  },
  {
    table: "evalCases",
    ownershipField: "userId",
    indexName: "by_user",
    relationshipFields: ["userId", "datasetId", "sourceAnalysisId"],
    deletionOrder: 77,
  },
  {
    table: "evalDatasets",
    ownershipField: "userId",
    indexName: "by_user",
    relationshipFields: ["userId", "creatorUserId"],
    deletionOrder: 78,
  },
  {
    table: "modelEvals",
